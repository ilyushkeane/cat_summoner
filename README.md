...
2. Показывает количество уникальных пользователей;    
3. Показывает топ названий и количество в каждом сегменте;    
4. Geo & Device Insights: Ранжирование по городам и типам устройств;    
5. Retention: Показывает % пользователей, которые решили нажать на кнопку и сыграть :).  
