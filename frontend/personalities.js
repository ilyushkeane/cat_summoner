export const personalities = [
    ...
    // ЭПИЧЕСКИЕ (Epic)
    { title: "Кото-Пират", tag: "costume-pirate", rarity: "Эпический", class: "epic", desc: "Йо-хо-хо! Сокровище (твоя миска) уже близко. Желаю попутного ветра во всех начинаниях!" },
